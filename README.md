...
Вызывать функцию необходимо внутри функции getTimeRemaining, поскольку временные функции seconds, minutes, hours, days заданы в локальной области видимости. Функция labelSetup задана через function declaration, следовательно мы можем вызвать ее в коде выше, чем она объявлена.<br>
